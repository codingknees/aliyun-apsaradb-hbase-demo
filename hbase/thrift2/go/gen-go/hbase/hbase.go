...
func (p *THBaseServiceExistsAllArgs)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem196 := &TGet{}
    if err := _elem196.Read(ctx, iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem196), err)
    }
    p.Tgets = append(p.Tgets, _elem196)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceGetMultipleArgs)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Tgets = append(p.Tgets, _elem198)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServicePutMultipleArgs)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem200 := &TPut{}
    if err := _elem200.Read(ctx, iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem200), err)
    }
    p.Tputs = append(p.Tputs, _elem200)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceDeleteMultipleArgs)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Tdeletes = append(p.Tdeletes, _elem201)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceDeleteMultipleResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    if err := _elem202.Read(ctx, iprot); err != nil {
...
func (p *THBaseServiceGetAllRegionLocationsResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  p.Success =  tSlice
  for i := 0; i < size; i ++ {
    _elem205 := &THRegionLocation{}
    if err := _elem205.Read(ctx, iprot); err != nil {
...
func (p *THBaseServiceGetTableDescriptorsArgs)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem206 := &TTableName{}
    if err := _elem206.Read(ctx, iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem206), err)
    }
    p.Tables = append(p.Tables, _elem206)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceGetTableDescriptorsResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  p.Success =  tSlice
  for i := 0; i < size; i ++ {
    _elem207 := &TTableDescriptor{}
    if err := _elem207.Read(ctx, iprot); err != nil {
...
func (p *THBaseServiceGetTableDescriptorsByPatternResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  p.Success =  tSlice
  for i := 0; i < size; i ++ {
    _elem208 := &TTableDescriptor{}
    if err := _elem208.Read(ctx, iprot); err != nil {
...
func (p *THBaseServiceGetTableDescriptorsByNamespaceResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  p.Success =  tSlice
  for i := 0; i < size; i ++ {
    _elem209 := &TTableDescriptor{}
    if err := _elem209.Read(ctx, iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem209), err)
    }
...
func (p *THBaseServiceGetTableNamesByPatternResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem210 := &TTableName{}
    if err := _elem210.Read(ctx, iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem210), err)
    }
...
func (p *THBaseServiceGetTableNamesByNamespaceResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem211 := &TTableName{}
    if err := _elem211.Read(ctx, iprot); err != nil {
...
var _elem213 []byte
    ...
    p.SplitKeys = append(p.SplitKeys, _elem213)
  }
  if err := iprot.ReadListEnd(ctx); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceListNamespaceDescriptorsResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  p.Success =  tSlice
  for i := 0; i < size; i ++ {
    _elem214 := &TNamespaceDescriptor{}
    if err := _elem214.Read(ctx, iprot); err != nil {
